...
{
    public class BasicConsulProvider : ConfigurationProvider
    {
        ...
        public BasicConsulProvider(ConsulClient consulClient, string consulKeyPath, bool reloadOnChanges)
        {
        ...
        private async Task<QueryResult<KVPair>> GetData()
        {
            ...
            throw new Exception($"加载Consul配置发生错误！状态码: {res.StatusCode}.");
        }
